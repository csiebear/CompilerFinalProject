...
Decl
	...
	;
VarDecl
	:Type ID VarDecl2{idStack.push_back($2);printf("the ID pushback in vector %s\n",idStack[position]);position++;}
	;
VarDecl2
	:SEMI
...
ParamDecl
	:Type ID ParamDecl2
	{	char str[]="idMain";
		int compare=1;compare=strcmp($2,str);
		if(compare==0)
			printf("Main:\n");
		 else printf("%s:\n",$2);
	 }
